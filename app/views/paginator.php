        ...
        <div class="col-xl-4">
            <div class="card border shadow-0 mb-g shadow-sm-hover" >
                ...
                <?php if ($paginator->getPrevUrl()): ?>
                    <li class="page-item"><a class="page-link bg-secondary" href="<?php echo $paginator->getPrevUrl(); ?>">Previous</a></li>
                    <?php endif; ?>
                    <?php foreach ($paginator->getPages() as $page): ?>
                        ...
                        <?php else: ?>
                    <li class="page-item"><a class="page-link bg-secondary" href="#" class="disabled"><?php echo $page['num']; ?></a></li>
                    <?php endif; ?>
                    <?php endforeach; ?>    
                    <?php if ($paginator->getNextUrl()): ?>
                    <li class="page-item"><a class="page-link bg-secondary" href="<?php echo $paginator->getNextUrl(); ?>">Next</a></li>
                    <?php endif; ?>
                </ul>
                </div>
            </div>
